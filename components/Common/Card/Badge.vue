<template>
  <div
    class="flex items-center w-fit px-1.5 py-[3px] rounded-md"
    :class="typesStyle[type]"
  >
    <div class="mr-1">
...
defineProps<{ type: TOrderBadgeTypes }>()

const typesStyle: Record<TOrderBadgeTypes, string> = {

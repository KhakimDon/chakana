<template>
  <div class="flex-center max-md:justify-start gap-2">
...
const detectIconClass = (idx: number) => {
  if (activeIndex.value === idx) {
    return 'border-white/40 bg-[linear-gradient(180deg,_#FF831B_0%,_#F30_100%)] sm:shadow-[0_9px_28px_0_rgba(255,_74,_8,_0.58)] text-white'
